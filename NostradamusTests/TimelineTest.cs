...
namespace Nostradamus.Tests
{
    ...
    public class TimelineTest
    {
        ...
        public void TestServerClientSyncSimulation()
        {
            ...
            var client_c3 = new Timeline();       // Create branch from last synchronized client branch
